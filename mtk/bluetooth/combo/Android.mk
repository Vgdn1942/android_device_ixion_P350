...
LOCAL_C_INCLUDES := \
  $(LOCAL_PATH)/../inc \
  $(TARGET_SPECIFIC_HEADER_PATH)/cfgfileinc \
  $(TARGET_SPECIFIC_HEADER_PATH)/cfgdefault
...
LOCAL_C_INCLUDES := \
  ...
  $(TARGET_SPECIFIC_HEADER_PATH)/cfgfileinc \
  $(TARGET_SPECIFIC_HEADER_PATH)/cfgdefault \
  $(TARGET_SPECIFIC_HEADER_PATH)/libnvram

ifeq ($(MTK_TC1_FEATURE),yes)
ifeq ($(MTK_GPT_SCHEME_SUPPORT), yes)
LOCAL_C_INCLUDES += \
	vendor/mediatek/proprietary/external/tc1_interface/gpt
else
LOCAL_C_INCLUDES += \
	vendor/mediatek/proprietary/external/tc1_interface/pmt
endif
