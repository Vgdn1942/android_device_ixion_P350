...
TARGET_PREBUILT_KERNEL := device/ixion/P350/kernel
BOARD_MKBOOTIMG_ARGS := --kernel_offset 0x00008000 --ramdisk_offset 0x04000000 --tags_offset 0x0e000000 --board 1441186574
BOARD_CUSTOM_BOOTIMG := true

TARGET_PREBUILT_RECOVERY_KERNEL := device/ixion/P350/kernel
TARGET_RECOVERY_FSTAB := device/ixion/P350/rootdir/fstab.mt6580
...
BOARD_BLUETOOTH_BDROID_BUILDCFG_INCLUDE_DIR := device/ixion/P350/bluetooth

# RIL
# BOARD_RIL_CLASS := ../../../device/ixion/P350/ril/
...
# GPS
TARGET_SPECIFIC_HEADER_PATH := device/ixion/P350/include
...
# EGL settings
BOARD_EGL_CFG := device/ixion/P350/config/lib/egl/egl.cfg
