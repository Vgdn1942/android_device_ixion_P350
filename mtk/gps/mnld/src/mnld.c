...
#define GPS_CALI_DATA_PATH "/data/nvram/md/NVRAM/CALIBRAT/EL6N_000"
#endif
/*---------------------------------------------------------------------------*/
enum {
...
static MNL_THREAD_T mnlmpe_thread[] = {
    ...
    if (strstr(buff, "set_storage_path")) {
        ...
        if (obj->state == GPS_STATE_START) {
            ...
            if (MTK_GPS_ERROR == ret) {
                ...
                MND_MSG("start gpsdbglog successfully\n");
            }
        ...
        if (obj->state == GPS_STATE_START) {
            ...
            if (MTK_GPS_ERROR== ret) {
                ...
                MND_MSG("Stop gpsdbglog successfully\n");
            }
        }
